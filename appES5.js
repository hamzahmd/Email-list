...
// Emaillist Contructor
function EmailList(name, company, email){
  this.name = name;
...
// Prototypes - adding email to list
UI.prototype.addEmailToList = function(emailList){
...
// Deleting emailings from the list 
